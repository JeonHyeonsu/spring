  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
          <label>퀴즈 질문</label> <input class="form-control" name='question'
            value='<c:out value="${quiz.question }"/>' readonly="readonly">
        </div>

        <div class="form-group">
          <label>Text area</label>
          <textarea class="form-control" rows="3" name='example1'
            readonly="readonly"><c:out value="${quiz.example1}" /></textarea>
        </div>
...
<form id='operForm' action="/boad/modify" method="get">
  <input type='hidden' id='bno' name='bno' value='<c:out value="${quiz.quiz_idx}"/>'>
...
$(document).ready(function () {
   ...
   var bnoValue = '<c:out value="${quiz.quiz_idx}"/>';
   var replyUL = $(".chat");
