         ...
         <div class="panel-body">
            ...
            <div class='row'>
               <div class="col-lg-12">
                  ...
                  <form id='searchForm' action="/front/list2" method='get'>
                     <select name='type'>
                        <option value=""
            ...
            <!-- 페이징 Form 시작 -->
            <form id='actionForm' action="/front/list2" method='get'>
...
<script type="text/javascript">
   $(document).ready(function() {
      ...
      $(".move").on("click",function(e) {
         e.preventDefault();
         actionForm.append("<input type='hidden' name='quiz_idx' value='" + $(this).attr("href")   + "'>");
